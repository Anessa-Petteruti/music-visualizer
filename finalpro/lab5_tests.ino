...
// */
// 
//const state test_states_in[23] = {(state) 1, (state) 1, (state) 1, (state) 1, (state) 2, (state) 2, (state) 2, (state) 3, (state) 3, (state) 4, (state) 4, (state) 4, (state) 5, (state) 5, (state) 5, (state) 6, (state) 6, (state) 6, (state) 7, (state) 1, (state) 1, (state) 1, (state) 1};
//const state test_states_out[23] = {(state) 1, (state) 1, (state) 2, (state) 6, (state) 2, (state) 3, (state) 3, (state) 4, (state) 7, (state) 4, (state) 5, (state) 5, (state) 2, (state) 6, (state) 7, (state) 6, (state) 1, (state) 7, (state) 7, (state) 1, (state) 1, (state) 2, (state) 6};
//const state_inputs test_input[23] = {{2,LEFT,600}, {2,DOWN,1600}, {2,LEFT,1300}, {3,LEFT,1300}, {3,LEFT,1500}, {2,LEFT,1900}, {0,DOWN,2000}, {2,DOWN,1300}, {3,LEFT,4}, {3,DOWN,1300}, {1,RIGHT,1300}, {0,RIGHT,1300}, {4,DOWN,1400}, {4,UP,1600}, {1,UP,4}, {0,RIGHT,1600}, {1,LEFT,1600}, {0,DOWN,1500}, {4,DOWN,0}, {0,DOWN,600}, {1,UP,1600}, {3,LEFT,2000}, {2,UP,2000}};
//const state_vars test_in_vars[23] = {{0,1,RIGHT,4,4,4,4,500,0}, {1,3,RIGHT,1,4,2,3,1000,0}, {4,3,RIGHT,4,13,3,0,400,-1}, {6,3,DOWN,4,13,2,1,400,-1}, {2,1,RIGHT,4,3,1,1000,900,4}, {5,5,UP,2,13,0,1000,700,0}, {0,3,UP,0,13,1,1000,1000,1}, {4,2,UP,3,7,0,4,1,3}, {0,0,LEFT,4,4,5,3,2,0}, {2,0,DOWN,0,3,2,1000,500,1}, {4,3,DOWN,1,8,3,0,100,1}, {4,3,DOWN,1,8,1,4,100,3}, {5,3,UP,4,8,4,2,2,0}, {4,2,LEFT,4,13,4,4,4,3}, {2,4,RIGHT,4,4,5,1,2,4}, {2,4,UP,2,4,1,1000,1300,4}, {0,3,LEFT,4,13,3,1000,600,4}, {1,0,DOWN,2,3,3,1000,400,3}, {3,0,LEFT,3,0,4,1,1,1}, {4,4,UP,4,1,4,4,500,4}, {3,2,DOWN,1,2,2,2,1000,0}, {5,0,DOWN,4,2,3,1000,1000,-1}, {5,0,UP,2,0,0,0,0,-1}};
//const state_vars test_out_vars[23] = {{0,1,RIGHT,4,4,4,4,500,0}, {1,3,RIGHT,1,4,2,3,1600,-1}, {4,3,RIGHT,4,13,3,0,1300,-1}, {6,3,DOWN,4,13,2,1,1300,-1}, {2,1,RIGHT,4,3,1,1000,900,4}, {5,4,UP,3,13,0,1000,700,0}, {0,2,UP,0,13,1,1000,1000,1}, {4,1,UP,3,7,0,4,1300,3}, {0,0,LEFT,4,4,5,3,2,0}, {2,0,DOWN,0,3,2,1000,500,1}, {4,3,LEFT,2,8,3,0,100,1}, {4,3,LEFT,1,8,1,4,100,3}, {5,3,UP,4,8,4,2,1400,0}, {4,2,LEFT,4,13,4,4,1600,3}, {2,4,RIGHT,4,4,5,1,2,4}, {2,4,UP,2,4,1,1000,1300,4}, {4,0,UP,4,13,4,950,1600,2}, {1,0,DOWN,2,3,3,1000,400,3}, {3,0,LEFT,3,0,4,1,1,1}, {4,4,UP,4,1,4,4,500,4}, {3,2,DOWN,1,2,2,2,1600,-1}, {5,0,DOWN,4,2,3,1000,2000,-1}, {5,0,UP,2,0,0,0,2000,-1}};
